...
public function StopPillDay(Request $request)
{
    $user = $request->user();
...
//特定ユーザーの使用履歴を取得
public function userLists(Request $request, int $userId)
{
    // ユーザーが存在するか確認
...
public function UserStopPillDay(Request $request, int $userId)
{
    $user = User::find($userId);
